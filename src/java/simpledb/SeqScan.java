...
public class SeqScan implements OpIterator {
	 ...
	 * name. The alias and name should be separated with a "." character (e.g.,
	 * "alias.fieldName").
	 *
	...
	public TupleDesc getTupleDesc() {
		...
		int numFieds = td.numFields();
		Type[] typeAr = new Type[numFieds];
		String[] fieldAr = new String[numFieds];
		for (int i = 0; i < numFieds; ++i) {
	...
	public boolean hasNext() throws TransactionAbortedException, DbException {
		// some code goes here
		// return false;
		return Database.getCatalog().getDatabaseFile(tableid).iterator(tid)
				.hasNext();
	}
